...
For inventory file variables setup refer to `link <https://gitlab-master.nvidia.com/sdn/ovn-isolation-deployment/-/blob/main/testing/control-plane/README.md?ref_type=heads>`__
...
For inventory file variables setup refer to `link <https://gitlab-master.nvidia.com/sdn/ovn-isolation-deployment/-/blob/main/testing/dpu/inventory?ref_type=heads>`__
